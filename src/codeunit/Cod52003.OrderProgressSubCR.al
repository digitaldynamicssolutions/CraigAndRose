...
codeunit 52003 "Order Progress Sub. CR"
{
    ...
    local procedure InsertOrderProgress(var pDocNo: Code[20]; pOrderNo: Code[20]; pProgressStatus: Enum "Order Progress CR"; pLocationCode: code[10]; pExtDocNo: Code[35]);
    var
        OrderProgressEntry: Record "Order Progress Entry CR";
    begin
